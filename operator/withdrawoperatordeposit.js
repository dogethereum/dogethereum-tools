...
async function doIt() {
  var argv = utils.completeYargs(yargs
      ...
      .usage('node operator/withdrawoperatordeposit.js --network <eth network> --operatorPublicKeyHash <operator public key hash> --value <number of weis to deposit> --ethAddress <operator eth address>')
